  ...
  <div>  
    ...
    <ArrowBackIcon className='ArrowBack_icon link' onClick={goToLogin}/>
      ...
      <div id="about_section">
        <h1 className="vision"><em>Our Vision</em></h1>
        <h3>ChatterBox came from a desire to create a better chat app. We wanted a fun and easy 
        outlet to speak with our friends. We checked out the competition but nothing was up to snuff, 
        after some long nights and great collaboration ChatterBox was born! <br></br>Chatter on mates! 
        </h3>
      </div>
    ...
    <div class="row">  
      <div class="column">
        <div class="card">
          <div class="Tatiana_container">
            <h2>Tatiana DeAngelo<span class="title"> Co-Founder</span></h2>
            ...
            <p>Tatiana DeAngelo, Bachelor's of Science Degree in Engineering, 
                ...
                Spring Boot, Hibernate, Angular, Ionic, Apache Spark and React.
      ...
      <div class="column">
        <div class="card">
          <div class="Zach_container">
            <h2>Zachary Kitto<span class="title">Co-Founder</span></h2>
            <img class="Zach" src="Zachary Kitto.jpg" alt="Zachary Kitto" width="250" height="225"/>
            <p>Zach is a former estimator for a mechanical insulation contractor. Produced accurate estimates 
              ...
              <a className = "linkedIn" href="https://www.linkedin.com/in/zachkitto/">Connect With Me</a>
              </p>
          </div> 
        </div>
      </div>
    ...
    <div class="column">
      <div class="card">
        <div class="container">
          <h2>Jeremy Sabina<span class="title">Co-Founder</span></h2>
        <img src="Jeremy .jpg" alt="Jeremy Sabina" width="250" height="225"/>
          <p>Jeremy Sabina, Dual-Associates degrees in Culinary Arts and Baking and
              ...
              HTML, and React.
          <a className = "linkedIn" href="https://www.linkedin.com/in/jeremysabina/">Connect With Me</a></p>
        </div>
      </div>
    </div>
    <br></br>
    ...
    <div class="column">
      <div class="card">
        <div class="container">
          <h2>Laura Bedolla Soria <span class="title">Co-Founder</span></h2>          
        <img src="lauraBS.jpg" alt="Laura Bedolla Soria" width="250" height="225"/>
          <p>Laura has had coursework from Delaware Tech for Health Sciences
            ...
            projects using Java; object-oriented programming;  Spring Boot,
             ...
             <a className = "linkedIn" href="https://www.linkedin.com/in/laura-bedolla-soria/">Connect With Me</a></p>
          <br></br>
        </div>
      </div>
    </div>
