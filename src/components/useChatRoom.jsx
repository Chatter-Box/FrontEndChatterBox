...
const SOCKET_SERVER_URL = "http://localhost:3030/message";
...
const useChatRoom = () => {
  ...
  // send the message along with a sender id. The sender id would allow us to style the UI just like a message app like iOS.
